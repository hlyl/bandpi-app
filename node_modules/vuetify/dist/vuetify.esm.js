...
import { Fragment, ref, computed, unref, provide, inject, defineComponent as defineComponent$1, getCurrentInstance as getCurrentInstance$1, shallowRef, shallowReactive, toRaw, watchEffect, watch, effectScope, capitalize, camelize, h, readonly, onBeforeUnmount, onDeactivated, onActivated, reactive, onMounted, createVNode, toRefs, TransitionGroup, Transition, mergeProps, onBeforeMount, nextTick, withDirectives, vShow, resolveDirective, isRef, toRef, resolveDynamicComponent, onScopeDispose, warn, toHandlers, Teleport, vModelDynamic, createTextVNode, onBeforeUpdate, vModelText } from 'vue';
...
function createTheme(app, options) {
  ...
  const styles = computed(() => {
    ...
    for (const themeName of Object.keys(computedThemes.value)) {
      ...
      lines.push(...createCssClass(`.v-theme--${themeName}`, [`color-scheme: ${dark ? 'dark' : 'normal'}`, ...genCssVariables(themeName), ...Object.keys(variables).map(key => {
        ...
        default: () => {
          ...
          return createVNode(Fragment, null, [createVNode(VMenu, {
            ...
            default: () => [createVNode(VList, {
              ...
              }, null)), items.value.map(item => createVNode(VListItem, mergeProps(item.props, {
            ...
            }, [selection.props.title, props.multiple && index < selections.value.length - 1 && createVNode("span", {
          ...
          return createVNode(Fragment, null, [activator.value && createVNode(VMenu, {
            ...
            default: () => [createVNode(VList, {
              ...
              default: () => [!filteredItems.value.length && !props.hideNoData && ((_slots$noData = (_slots$noData2 = slots['no-data']) == null ? void 0 : _slots$noData2.call(slots)) != null ? _slots$noData : createVNode(VListItem, {
                ...
                return createVNode(VListItem, mergeProps(item.props, {
                  "onMousedown": e => e.preventDefault(),
                  "onClick": () => select(item)
                }), {
                  title: () => {
...
const version = "3.0.0-next-20220531.0";
